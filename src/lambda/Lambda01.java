...
//        İşleme başlarken bir önceki değer olmadığı için bu değer identity parametresinde tanımlanmaktadır.
    ...
    // 1.) TODO task tek sayilarin  karesini buyukten kucuge
    ...
    // 2.) Task : List elemanlarini alafabetik buyuk harf ve  tekrarsiz print ediniz.
    ...
    // 4.) Task :TODO list elemanlarinin son harfine gore ters sirali print ediniz.
    ...
    // 5.) Task : listin elemanlarin karakterlerinin cift sayili  karelerini hesaplayan,ve karelerini tekrarsiz
    ...
    // 6.) TODO Task : List elemalarinin karakter sayisini 7 ve 7 'den az olma durumunu kontrol ediniz.
    public static void karakterSayiYedidenBuyuk(List<String> yemek) {
        ...
        System.out.println(yemek.stream().
                allMatch(t -> t.length() <= 7) ? //7 den kucuk olma durumu kontrolu
                "list elemanlari 7 ve daha az harften olusmus" :       //ternary
...
System.out.println("yemek.stream().noneMatch(t->t.toString().length()<7) = " + yemek.stream().noneMatch(t -> t.toString().length() < 7));
    ...
    // 8.) TODO Task : List elelmanlarinin "x" ile biten en az bir elemaı kontrol ediniz.
    public static void xIleBitenEleman(List<String> yemek) {
        System.out.println(yemek.stream().anyMatch(t -> t.endsWith("x")));
    }


    // 9.) TODO Task : Karakter sayisi en buyuk elemani yazdiriniz.
...
kullanılabilir.
*/
    //10.)TODO Task : list elemanlarini son harfine göre siralayıp ilk eleman hariç kalan elemanlari print ediniz.
